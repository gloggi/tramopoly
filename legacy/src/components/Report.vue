    ...
    <div class="column is-full has-text-centered">
      <div class="card" v-if="allVisitsCombined.length">
        <header class="card-header has-background-light">
          <span class="card-header-title title is-4">Billet-Kontrolle</span>
        </header>
        <b-table
          class="has-content-vcentered"
          :data="allVisitsCombined"
          striped
          hoverable
          ...
          <template v-slot="props">
            <b-table-column field="group.abteilung.name" label="Abt." sortable>
              <span v-if="props.row.group.abteilung">{{
                props.row.group.abteilung.name
              }}</span>
            </b-table-column>
            ...
            <b-table-column field="type" label="Aktion" sortable>
              ...
              <span
                v-else-if="props.row.type === 'station'"
                :key="props.row.id"
              >
                <span class="icon">🚉</span>
